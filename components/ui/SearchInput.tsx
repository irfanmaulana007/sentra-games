  ...
  return (
    <div className={`relative w-full ${className}`}>
      <input
        ...
        className="pl-4 pr-10 py-2 rounded-md border border-sidebar-border bg-background text-sidebar-foreground focus:outline-none focus:ring-2 focus:ring-sidebar-primary/50 w-full"
